...
from minial_agent.agents.domain.office_file_agent.subagents.agent_pptx.workflow.read.prompts import PAGE_SCAN_PROMPT
...
def build_pptx_answer(relevant_pages: list[dict], scanned_pages: int) -> dict:
