...
from minial_agent.agents.domain.office_file_agent.subagents.agent_pdf.workflow.read.prompts import PAGE_SCAN_PROMPT
...
def build_pdf_answer(relevant_pages: list[dict], scanned_pages: int) -> dict:
