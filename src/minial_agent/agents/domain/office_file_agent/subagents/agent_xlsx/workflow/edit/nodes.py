...
from minial_agent.agents.domain.office_file_agent.subagents.agent_xlsx.utils.editing import apply_xlsx_edit
from minial_agent.agents.domain.office_file_agent.subagents.agent_xlsx.workflow.edit.prompts import OPERATION_PROMPT, SLOT_PROMPT
