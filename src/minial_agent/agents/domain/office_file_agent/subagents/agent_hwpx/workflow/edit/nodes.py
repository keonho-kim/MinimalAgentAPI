...
from minial_agent.agents.domain.office_file_agent.subagents.agent_hwpx.utils.editing import apply_hwpx_edit
from minial_agent.agents.domain.office_file_agent.subagents.agent_hwpx.workflow.edit.prompts import OPERATION_PROMPT, SLOT_PROMPT
