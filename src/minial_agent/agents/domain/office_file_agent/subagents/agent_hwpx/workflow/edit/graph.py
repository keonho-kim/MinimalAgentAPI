...
from minial_agent.agents.domain.office_file_agent.subagents.agent_hwpx.workflow.edit.nodes import apply_hwpx_edit_spec, build_hwpx_edit_spec, register_hwpx_edit_result, resolve_hwpx_artifact
from minial_agent.agents.domain.office_file_agent.subagents.agent_hwpx.workflow.edit.state import HwpxEditState
...
def build_hwpx_edit_workflow(
    ...
    *,
    ...
    graph.add_node(
        ...
        lambda state: _build_hwpx_edit_spec(
            state,
    ...
    graph.add_node(
        ...
        lambda state: _apply_hwpx_edit_spec(state, workspace=workspace),
    )
    graph.add_node(
        "register_hwpx_edit_result",
        lambda state: _register_hwpx_edit_result(state, workspace=workspace),
    )
...
def _register_hwpx_edit_result(
    state: HwpxEditState,
    *,
    workspace: UploadWorkspace,
) -> HwpxEditState:
