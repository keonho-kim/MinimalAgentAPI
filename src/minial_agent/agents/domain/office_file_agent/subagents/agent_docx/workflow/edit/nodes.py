...
from minial_agent.agents.domain.office_file_agent.subagents.agent_docx.utils.editing import apply_docx_edit
from minial_agent.agents.domain.office_file_agent.subagents.agent_docx.workflow.edit.prompts import OPERATION_PROMPT, SLOT_PROMPT
