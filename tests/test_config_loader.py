...
def test_set_config_loads_project_root_env() -> None:
    ...
    assert os.environ["LLM_BASE_URL"] == "https://llm.lgcns-techhub.com/v1"
    assert os.environ["LLM_MODEL_NAME"] == "google/gemma-4-31B-it"
    assert os.environ["LLM_MAX_TOKENS"] == "8192"
    assert os.environ["LLM_API_KEY"] == "EMPTY"
    assert os.environ["LLM_TLS_VERIFY"] == "false"
